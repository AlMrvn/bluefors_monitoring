...
class bluefors_monitor:
    LABEL_TEXT = [
        "Monitoring the temperature of the Bluefors Fridge",
        "Will send a notification on slack if something bad happen",
    ]
    def __init__(self, master):
        ...
        self.T_4K_button = Button(master, 
                                 text="Set 4K",
                                 command=self.set_4K)
        ...
        self.T_still_button = Button(master,
                                    text="Set Still",
